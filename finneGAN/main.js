...
function ensureTranscriptionNodes() {
  let container = document.getElementById('transcription-space') || document.getElementById('transcription')
  if (!container) {
    container = document.createElement('div')
    container.id = 'transcription-space'
    document.body.appendChild(container)
  }
  let panel = container.querySelector('.transcription-panel') || container.querySelector('#transcription-inner')
  if (!panel) {
    panel = document.createElement('div')
    panel.id = 'transcription-inner'
...
const { panel: transcriptionPanel } = ensureTranscriptionNodes()
...
if (!CANVAS) {
  APP_ROOT.appendChild(renderer.domElement)
}
